...
#SBATCH --output=train_CPC_unfrozen_5.out
#SBATCH --gres gpu:1
...
python Train.py --epochs 100 --lr 0.00310303348696595 --max_lr 0.028885041334915096 --batch_size 61 --output_name "CPC_unfrozen_5"\
    --data_percentage 5 --n_predictions 5 --n_negatives 16 --n_past_latents 1 --replicate_CPC_params --checkpoint_file $CHECKPOINT_FILE